...
class MortarCalculatorApp(tk.Tk):
    ...
    def calculate_all(self):
        try:
            ...
            delta_easting, delta_northing = target_easting - mortar_easting, target_northing - mortar_northing
            ...
            if not valid_solutions: raise ValueError("No valid charges for this range")
